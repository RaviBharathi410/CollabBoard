    ...
    <div className="auth-container">
      ...
      <div className="auth-visuals">
        ...
        <div className="auth-visuals-content">
          ...
          <h2>{isLogin ? 'Welcome back to CollabBoard' : 'Start your creative journey'}</h2>
          <p>
            {isLogin 
      ...
      <div className="auth-form-section">
        <div className="auth-form-wrapper">
          ...
          <div className="auth-header">
            ...
            <p>{isLogin ? 'Enter your credentials to continue.' : 'Enter your details to get started.'}</p>
          </div>
          ...
          <div className="auth-socials">
            <button className="btn btn-secondary social-btn" onClick={handleGoogleAuth} disabled={loading} type="button">
